...
/**
 * Created by pterede on 8/23/2016.
 */
...
public class TooltipWindow {
    ...
    public TooltipWindow(Context ctx) {
        ...
        contentView = inflater.inflate(R.layout.tt, null);
...
// Get location of anchor view on screen
        //PARAG:anchor.getLocationOnScreen(screen_pos);
...
// send message to handler to dismiss tipWindow after X milliseconds
        handler.sendEmptyMessageDelayed(MSG_DISMISS_TOOLTIP, 8000);
    }
